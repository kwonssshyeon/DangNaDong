...
<html lang="ko">
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
    ...
    <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
      ...
      function deleteIntroductionPost(postId) {
    	  console.log(postId);
          // 서버로 해당 게시글의 Post_id를 전송하여 삭제 요청
          $.ajax({
              type: "POST",
              url: "<%=request.getContextPath()%>" + "/DeleteIntroductionPostServlet",
              data: {post_id: postId},
          ...
          <div class="row row-cols-1 row-cols-md-2" style="margin-left: 10px; margin-top: 10px;">
            ...
            <% 
              ...
              try {
                ...
                String query = "SELECT TI.Title, TI.Content_text,TI.Post_id FROM TRAVEL_INTRODUCTION_POST TI WHERE TI.Member_id = ?"; 
            ...
            <div class="col mb-4">
              <div class="card" style="border: 1px solid #ffc300; border-radius: 5px; padding: 10px;">
                <div class="card-body">
                  ...
                  <a href="./introducePostEdit.jsp?post_id=<%=PostId %>" class="btn btn-primary" style="background-color: #ffc300; color: #ffffff;">수정</a>
                   <button onclick="deleteIntroductionPost(<%=PostId %>);" class="btn btn-primary" style="background-color: #ffc300; color: #ffffff;">삭제
                </div>
              </div>
            </div>
            <%
