    ...
    <div class="frame">
      ...
      <div class="centerFrame">
        <div class="contentArea">
			<h3 style="margin-bottom: 30px;">좋아요 글 목록</h3>
...
<div class="list-group">
  ...
  <a href="./myPageLikeList.jsp" class="list-group-item list-group-item-action  active" aria-current="true" style="background-color: #ffc300";>좋아요 글 목록</a>
